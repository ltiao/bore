...
@click.option("--num-restarts", "-n", default=50)
...
def main(dimensions, num_restarts, method, max_iter, ftol, output_dir, seed):
    ...
    results = minimize_multi_start(michalewicz, bounds,
